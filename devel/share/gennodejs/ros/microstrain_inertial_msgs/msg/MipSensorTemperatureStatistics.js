...
class MipSensorTemperatureStatistics {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('min_temp')) {
        this.min_temp = initObj.min_temp
      }
      else {
        this.min_temp = 0.0;
      }
      ...
      if (initObj.hasOwnProperty('mean_temp')) {
        this.mean_temp = initObj.mean_temp
      }
      else {
        this.mean_temp = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [min_temp]
    bufferOffset = _serializer.float32(obj.min_temp, buffer, bufferOffset);
    // Serialize message field [max_temp]
    bufferOffset = _serializer.float32(obj.max_temp, buffer, bufferOffset);
    // Serialize message field [mean_temp]
    bufferOffset = _serializer.float32(obj.mean_temp, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MipSensorTemperatureStatistics(null);
    // Deserialize message field [header]
    data.header = MipHeader.deserialize(buffer, bufferOffset);
    // Deserialize message field [min_temp]
    data.min_temp = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [max_temp]
    data.max_temp = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [mean_temp]
    data.mean_temp = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'microstrain_inertial_msgs/MipSensorTemperatureStatistics';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '6fabd50ba1c185e5cd64c5539c067111';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MipSensorTemperatureStatistics(null);
    ...
    if (msg.min_temp !== undefined) {
      resolved.min_temp = msg.min_temp;
    }
    else {
      resolved.min_temp = 0.0
    }
    ...
    if (msg.max_temp !== undefined) {
      ...
      resolved.max_temp = 0.0
    }

    if (msg.mean_temp !== undefined) {
      resolved.mean_temp = msg.mean_temp;
    }
    else {
      resolved.mean_temp = 0.0
    }
...
module.exports = MipSensorTemperatureStatistics;
