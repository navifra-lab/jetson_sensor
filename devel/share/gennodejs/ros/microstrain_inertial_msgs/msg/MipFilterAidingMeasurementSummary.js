...
let MipFilterAidingMeasurementSummaryIndicator = require('./MipFilterAidingMeasurementSummaryIndicator.js');

//-----------------------------------------------------------

class MipFilterAidingMeasurementSummary {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('indicator')) {
        ...
        this.indicator = new MipFilterAidingMeasurementSummaryIndicator();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MipFilterAidingMeasurementSummaryIndicator.serialize(obj.indicator, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MipFilterAidingMeasurementSummary(null);
    ...
    data.indicator = MipFilterAidingMeasurementSummaryIndicator.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MipFilterAidingMeasurementSummary(null);
    ...
    if (msg.indicator !== undefined) {
      resolved.indicator = MipFilterAidingMeasurementSummaryIndicator.Resolve(msg.indicator)
    }
    else {
      resolved.indicator = new MipFilterAidingMeasurementSummaryIndicator()
    }
...
MipFilterAidingMeasurementSummary.Constants = {
  TYPE_GNSS: 1,
  TYPE_DUAL_ANTENNA: 2,
  TYPE_HEADING: 3,
  TYPE_PRESSURE: 4,
...
module.exports = MipFilterAidingMeasurementSummary;
