...
class MipFilterMultiAntennaOffsetCorrection {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('offset')) {
        ...
        this.offset = new Array(3).fill(0);
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.offset.length !== 3) {
      throw new Error('Unable to serialize array field offset - length must be 3')
    }
    // Serialize message field [offset]
    bufferOffset = _arraySerializer.float32(obj.offset, buffer, bufferOffset, 3);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MipFilterMultiAntennaOffsetCorrection(null);
    ...
    data.offset = _arrayDeserializer.float32(buffer, bufferOffset, 3)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MipFilterMultiAntennaOffsetCorrection(null);
    ...
    if (msg.offset !== undefined) {
      ...
      resolved.offset = new Array(3).fill(0)
    }
...
module.exports = MipFilterMultiAntennaOffsetCorrection;
