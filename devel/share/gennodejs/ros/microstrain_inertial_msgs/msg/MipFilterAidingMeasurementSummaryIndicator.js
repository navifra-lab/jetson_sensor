...
class MipFilterAidingMeasurementSummaryIndicator {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MipFilterAidingMeasurementSummaryIndicator(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MipFilterAidingMeasurementSummaryIndicator(null);
...
module.exports = MipFilterAidingMeasurementSummaryIndicator;
