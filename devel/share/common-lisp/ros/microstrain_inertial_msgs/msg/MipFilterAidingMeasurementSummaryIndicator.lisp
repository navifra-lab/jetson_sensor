...
;//! \htmlinclude MipFilterAidingMeasurementSummaryIndicator.msg.html

(cl:defclass <MipFilterAidingMeasurementSummaryIndicator> (roslisp-msg-protocol:ros-message)
  ((enabled
    :reader enabled
    :initarg :enabled
    :type cl:boolean
...
(cl:defclass MipFilterAidingMeasurementSummaryIndicator (<MipFilterAidingMeasurementSummaryIndicator>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MipFilterAidingMeasurementSummaryIndicator>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MipFilterAidingMeasurementSummaryIndicator)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name microstrain_inertial_msgs-msg:<MipFilterAidingMeasurementSummaryIndicator> is deprecated: use microstrain_inertial_msgs-msg:MipFilterAidingMeasurementSummaryIndicator instead.")))

(cl:ensure-generic-function 'enabled-val :lambda-list '(m))
(cl:defmethod enabled-val ((m <MipFilterAidingMeasurementSummaryIndicator>))
...
(cl:defmethod used-val ((m <MipFilterAidingMeasurementSummaryIndicator>))
...
(cl:defmethod residual_high_warning-val ((m <MipFilterAidingMeasurementSummaryIndicator>))
...
(cl:defmethod sample_time_warning-val ((m <MipFilterAidingMeasurementSummaryIndicator>))
...
(cl:defmethod configuration_error-val ((m <MipFilterAidingMeasurementSummaryIndicator>))
...
(cl:defmethod max_num_meas_exceeded-val ((m <MipFilterAidingMeasurementSummaryIndicator>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MipFilterAidingMeasurementSummaryIndicator>) ostream)
  "Serializes a message object of type '<MipFilterAidingMeasurementSummaryIndicator>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MipFilterAidingMeasurementSummaryIndicator>) istream)
  "Deserializes a message object of type '<MipFilterAidingMeasurementSummaryIndicator>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MipFilterAidingMeasurementSummaryIndicator>)))
  "Returns string type for a message object of type '<MipFilterAidingMeasurementSummaryIndicator>"
  "microstrain_inertial_msgs/MipFilterAidingMeasurementSummaryIndicator")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MipFilterAidingMeasurementSummaryIndicator)))
  "Returns string type for a message object of type 'MipFilterAidingMeasurementSummaryIndicator"
  "microstrain_inertial_msgs/MipFilterAidingMeasurementSummaryIndicator")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MipFilterAidingMeasurementSummaryIndicator>)))
  "Returns md5sum for a message object of type '<MipFilterAidingMeasurementSummaryIndicator>"
  "4e3131125b51ac75dceed1517c488713")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MipFilterAidingMeasurementSummaryIndicator)))
  "Returns md5sum for a message object of type 'MipFilterAidingMeasurementSummaryIndicator"
  "4e3131125b51ac75dceed1517c488713")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MipFilterAidingMeasurementSummaryIndicator>)))
  "Returns full string definition for message of type '<MipFilterAidingMeasurementSummaryIndicator>"
  (cl:format cl:nil "# Message definition for the indicator field of https://s3.amazonaws.com/files.microstrain.com/GQ7+User+Manual/external_content/dcp/Data/filter_data/data/mip_field_filter_aiding_measurement_summary.htm?Highlight=filter%20aiding%20measurement~%#   Note: This message will never be published on it's own, only included in other messages~%~%bool enabled~%bool used~%bool residual_high_warning~%bool sample_time_warning~%bool configuration_error~%bool max_num_meas_exceeded~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MipFilterAidingMeasurementSummaryIndicator)))
  "Returns full string definition for message of type 'MipFilterAidingMeasurementSummaryIndicator"
  (cl:format cl:nil "# Message definition for the indicator field of https://s3.amazonaws.com/files.microstrain.com/GQ7+User+Manual/external_content/dcp/Data/filter_data/data/mip_field_filter_aiding_measurement_summary.htm?Highlight=filter%20aiding%20measurement~%#   Note: This message will never be published on it's own, only included in other messages~%~%bool enabled~%bool used~%bool residual_high_warning~%bool sample_time_warning~%bool configuration_error~%bool max_num_meas_exceeded~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MipFilterAidingMeasurementSummaryIndicator>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MipFilterAidingMeasurementSummaryIndicator>))
  "Converts a ROS message object to a list"
  (cl:list 'MipFilterAidingMeasurementSummaryIndicator
