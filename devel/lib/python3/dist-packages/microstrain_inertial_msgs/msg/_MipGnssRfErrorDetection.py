...
"""autogenerated by genpy from microstrain_inertial_msgs/MipGnssRfErrorDetection.msg. Do not edit."""
import codecs
import sys
...
class MipGnssRfErrorDetection(genpy.Message):
  _md5sum = "31a70c5661fd36dfd41faec104fad00d"
  _type = "microstrain_inertial_msgs/MipGnssRfErrorDetection"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Message definition for the MIP field https://s3.amazonaws.com/files.microstrain.com/GQ7+User+Manual/external_content/dcp/Data/gnss_recv_1/data/mip_field_gnss_rf_error_detection.htm
...
bool time_valid"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,rf_band,jamming_state,spoofing_state
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_BQdH6B().pack(_x.header.event_source, _x.header.reference_timestamp, _x.header.gps_timestamp.tow, _x.header.gps_timestamp.week_number, _x.header.gps_timestamp.valid_flags.tow, _x.header.gps_timestamp.valid_flags.week_number, _x.header.gps_timestamp.valid_flags.time_valid, _x.rf_band, _x.jamming_state, _x.spoofing_state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.event_source, _x.header.reference_timestamp, _x.header.gps_timestamp.tow, _x.header.gps_timestamp.week_number, _x.header.gps_timestamp.valid_flags.tow, _x.header.gps_timestamp.valid_flags.week_number, _x.header.gps_timestamp.valid_flags.time_valid, _x.rf_band, _x.jamming_state, _x.spoofing_state,) = _get_struct_BQdH6B().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_BQdH6B = None
def _get_struct_BQdH6B():
    global _struct_BQdH6B
    if _struct_BQdH6B is None:
        _struct_BQdH6B = struct.Struct("<BQdH6B")
    return _struct_BQdH6B
