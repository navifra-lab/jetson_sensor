...
"""autogenerated by genpy from microstrain_inertial_msgs/MipFilterAidingMeasurementSummaryIndicator.msg. Do not edit."""
import codecs
import sys
...
class MipFilterAidingMeasurementSummaryIndicator(genpy.Message):
  _md5sum = "4e3131125b51ac75dceed1517c488713"
  _type = "microstrain_inertial_msgs/MipFilterAidingMeasurementSummaryIndicator"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Message definition for the indicator field of https://s3.amazonaws.com/files.microstrain.com/GQ7+User+Manual/external_content/dcp/Data/filter_data/data/mip_field_filter_aiding_measurement_summary.htm?Highlight=filter%20aiding%20measurement
