...
"""autogenerated by genpy from microstrain_inertial_msgs/MipFilterMultiAntennaOffsetCorrection.msg. Do not edit."""
import codecs
import sys
...
class MipFilterMultiAntennaOffsetCorrection(genpy.Message):
  _md5sum = "a09216595b1abaa0bdc1b370adbb4ced"
  _type = "microstrain_inertial_msgs/MipFilterMultiAntennaOffsetCorrection"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Message definition for the MIP field https://s3.amazonaws.com/files.microstrain.com/GQ7+User+Manual/external_content/dcp/Data/filter_data/data/mip_field_filter_multi_antenna_offset_correction.htm
...
bool time_valid"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.offset = _get_struct_3f().unpack(str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.offset = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
def _get_struct_3f():
    ...
    return _struct_3f
_struct_BQdH4B = None
def _get_struct_BQdH4B():
    global _struct_BQdH4B
    if _struct_BQdH4B is None:
        _struct_BQdH4B = struct.Struct("<BQdH4B")
    return _struct_BQdH4B
